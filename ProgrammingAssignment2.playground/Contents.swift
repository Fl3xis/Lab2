...
// ["ІВ-72": 13.4944447, "ІВ-73": 14.766667, "ІВ-71": 16.5444447]
...
class CoordinateAV {
    ...
    func midpoint(another: CoordinateAV) -> CoordinateAV? {
        if self.direction != another.direction {
            return nil
        } else {
            let coordinate = try! CoordinateAV(
    ...
    static func midpoint(one: CoordinateAV, another: CoordinateAV) -> CoordinateAV? {
...
let c1 = CoordinateAV(direction: .north)
let c2 = try! CoordinateAV(direction: .north,
                           degree: 50,
                           minute: 13,
                           second: 22)
print(c1.toString1())
...
print(m1.toString1())
let m2 = try! CoordinateAV.midpoint(one: c1, another: c2)!
print(m2.toString2())
